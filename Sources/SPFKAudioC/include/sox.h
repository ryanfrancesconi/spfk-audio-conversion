...
/** @file
   ...
   Symbols starting with "sox_" or "SOX_" are part of the interface for
...
/**
   Client API:
   Run main from within your program
   @returns SOX_SUCCESS if successful.
 */
int
LSX_API
sox_main(int argc, char **argv);
...
/*****************************************************************************
   ...
   exist in the header because sox (the application) currently uses them.
